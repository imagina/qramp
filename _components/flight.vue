  ...
  methods: {
    ...
    setTable(data) {
      data.forEach((items, index) => {
        ...
        const inboundTime = items.estimatedOn ? this.$moment(items.estimatedOn).format('DD-MM-YYYY HH:mm') : '';
        const outboundTime = items.estimatedOff ? this.$moment(items.estimatedOff).format('DD-MM-YYYY HH:mm') : '';
